"""
Agglomerative clustering analysis on FULL feature width (all 11008 features).

This script runs the complete analysis without feature limits.
...
def analyze_matrix_full(
    ...
    n_clusters_list: List[int] = [10, 50, 100, 500, 1000]
) -> Dict:
    """
...
def main():
    """Run FULL agglomerative clustering analysis on SparseGPT matrices."""
    ...
    # Find all SparseGPT down_proj matrices
