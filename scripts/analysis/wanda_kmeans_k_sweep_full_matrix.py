#!/usr/bin/env python3
"""
Wanda K-means Separation Ratio Experiment - FULL MATRIX

Run k-means clustering on ENTIRE Wanda matrices (all features, not just 128)
...
def main():
    """Run clustering analysis on FULL Wanda matrices with extended k values."""

    # Define paths using absolute paths
    base_dir = Path(__file__).resolve().parent.parent.parent
    wanda_dir = base_dir / "data" / "clustering" / "wanda"
    output_dir = base_dir / "results" / "metrics" / "wanda_kmeans_k_sweep_full"
    ...
    print("\n" + "="*80)
    print("WANDA K-MEANS K-VALUE SWEEP - FULL MATRIX ANALYSIS")
    ...
    output_file = output_dir / "wanda_kmeans_k_sweep_full_results.json"
