#!/usr/bin/env python3
"""
Wanda K-means Separation Ratio Experiment

Run k-means clustering on Wanda matrices with k ∈ {4, 8, 16, 32, 64}
...
def main():
    """Run clustering analysis on Wanda matrices with extended k values."""

    # Define paths using absolute paths
    base_dir = Path(__file__).resolve().parent.parent.parent
    wanda_dir = base_dir / "data" / "clustering" / "wanda"
    output_dir = base_dir / "results" / "metrics" / "wanda_kmeans_k_sweep"
    ...
    print("\n" + "="*80)
    print("WANDA K-MEANS K-VALUE SWEEP")
    ...
    output_file = output_dir / "wanda_kmeans_k_sweep_results.json"
